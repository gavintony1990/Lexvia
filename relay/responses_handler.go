...
import (
	...
	appconstant "github.com/gavintony1990/Lexvia/constant"
...
func ResponsesHelper(c *gin.Context, info *relaycommon.RelayInfo) (newAPIError *types.NewAPIError) {
	...
	if model_setting.GetGlobalSettings().PassThroughRequestEnabled || info.ChannelSetting.PassThroughBodyEnabled {
		...
		if !ok {
			return types.NewError(fmt.Errorf("channel does not support OpenAI Responses"), types.ErrorCodeConvertRequestFailed, types.ErrOptionWithSkipRetry())
		}
		convertedRequest, err := responsesAdaptor.ConvertOpenAIResponsesRequest(c, info, *request)
		if err != nil {
