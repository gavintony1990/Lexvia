...
import (
	...
	chn "github.com/gavintony1990/Lexvia/relay/channel"
...
func TestAllChannels(c *gin.Context) {
	task, created, err := service.EnqueueSystemTask(model.SystemTaskTypeChannelTest, controller.ChannelTestTaskPayload{
